...
func NewChunkedUploadSessionRepository(db mongo.Database, collection string) scene_audio_db_interface.ChunkedUploadSessionRepository {
...
func (r *chunkedUploadSessionRepository) Create(ctx context.Context, entity *scene_audio_db_models.ChunkedUploadSession) error {
	entity.SetTimestamps()
	_, err := r.db.Collection(r.collection).InsertOne(ctx, entity)
	return err
}

func (r *chunkedUploadSessionRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*scene_audio_db_models.ChunkedUploadSession, error) {
	var entity scene_audio_db_models.ChunkedUploadSession
...
func (r *chunkedUploadSessionRepository) GetAll(ctx context.Context) ([]*scene_audio_db_models.ChunkedUploadSession, error) {
	...
	var entities []*scene_audio_db_models.ChunkedUploadSession
...
// Custom methods
func (r *chunkedUploadSessionRepository) GetByUploadID(ctx context.Context, uploadID string) (*scene_audio_db_models.ChunkedUploadSession, error) {
	var entity scene_audio_db_models.ChunkedUploadSession
...
func (r *chunkedUploadSessionRepository) Upsert(ctx context.Context, entity *scene_audio_db_models.ChunkedUploadSession) error {
	entity.SetTimestamps()
...
func (r *chunkedUploadSessionRepository) CreateMany(ctx context.Context, entities []*scene_audio_db_models.ChunkedUploadSession) error {
	if len(entities) == 0 {
		return nil
	}
...
func (r *chunkedUploadSessionRepository) BulkUpsert(ctx context.Context, entities []*scene_audio_db_models.ChunkedUploadSession) (int, error) {
...
func (r *chunkedUploadSessionRepository) GetByFilter(ctx context.Context, filter interface{}) ([]*scene_audio_db_models.ChunkedUploadSession, error) {
...
func (r *chunkedUploadSessionRepository) GetOneByFilter(ctx context.Context, filter interface{}) (*scene_audio_db_models.ChunkedUploadSession, error) {
	var entity scene_audio_db_models.ChunkedUploadSession
...
func (r *chunkedUploadSessionRepository) GetPaginated(ctx context.Context, filter interface{}, skip, limit int64) ([]*scene_audio_db_models.ChunkedUploadSession, error) {
