...
func NewArtistRepository(db mongo.Database, collection string) artistCore.ArtistRepository {
...
func (r *artistRepository) Upsert(ctx context.Context, artist *artistCore.ArtistMetadata) error {
...
func (r *artistRepository) BulkUpsert(ctx context.Context, artists []*artistCore.ArtistMetadata) (int, error) {
	coll := r.db.Collection(r.collection)
...
func (r *artistRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*artistCore.ArtistMetadata, error) {
	coll := r.db.Collection(r.collection)
	result := coll.FindOne(ctx, bson.M{"_id": id})

	var artist artistCore.ArtistMetadata
...
func (r *artistRepository) GetByName(ctx context.Context, name string) (*artistCore.ArtistMetadata, error) {
	coll := r.db.Collection(r.collection)
...
func (r *artistRepository) GetAllCounts(ctx context.Context) ([]artistCore.ArtistAlbumAndSongCounts, error) {
	coll := r.db.Collection(r.collection)
	...
	var results []artistCore.ArtistAlbumAndSongCounts
...
func (r *artistRepository) GetByMbzID(ctx context.Context, mbzID string) (*artistCore.ArtistMetadata, error) {
	coll := r.db.Collection(r.collection)
...
func (r *artistRepository) UpdateArtistAlbums(ctx context.Context, artistID primitive.ObjectID, albumIDs []artistCore.ArtistIDPair) error {
	coll := r.db.Collection(r.collection)
...
func (r *artistRepository) UpdateArtistGuestAlbums(ctx context.Context, artistID primitive.ObjectID, albumIDs []artistCore.ArtistIDPair) error {
	coll := r.db.Collection(r.collection)
