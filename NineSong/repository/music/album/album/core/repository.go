...
func NewAlbumRepository(db mongo.Database, collection string) albumCore.AlbumRepository {
...
func (r *albumRepository) Upsert(ctx context.Context, album *albumCore.AlbumMetadata) error {
...
func (r *albumRepository) BulkUpsert(ctx context.Context, albums []*albumCore.AlbumMetadata) (int, error) {
	coll := r.db.Collection(r.collection)
...
func (r *albumRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*albumCore.AlbumMetadata, error) {
	coll := r.db.Collection(r.collection)
	result := coll.FindOne(ctx, bson.M{"_id": id})

	var album albumCore.AlbumMetadata
...
func (r *albumRepository) GetByName(ctx context.Context, name string) (*albumCore.AlbumMetadata, error) {
	coll := r.db.Collection(r.collection)
...
func (r *albumRepository) GetByArtist(ctx context.Context, artistID string) ([]*albumCore.AlbumMetadata, error) {
	coll := r.db.Collection(r.collection)
	filter := bson.M{
		"$or": []bson.M{
			{"artist_id": artistID},
	...
	var albums []*albumCore.AlbumMetadata
...
func (r *albumRepository) GetAllCounts(ctx context.Context) ([]albumCore.AlbumSongCounts, error) {
	coll := r.db.Collection(r.collection)
	...
	var results []albumCore.AlbumSongCounts
...
func (r *albumRepository) GetByMbzID(ctx context.Context, mbzID string) (*albumCore.AlbumMetadata, error) {
	coll := r.db.Collection(r.collection)
...
func (r *albumRepository) GetByFilterSingle(
	ctx context.Context,
	filter interface{},
