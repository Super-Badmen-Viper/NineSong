...
func NewMediaLibraryAudioRepository(db mongo.Database, collection string) domainCore.MediaLibraryAudioRepository {
...
func (r *mediaLibraryAudioRepository) Create(ctx context.Context, entity *domainCore.MediaLibraryAudio) error {
...
func (r *mediaLibraryAudioRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*domainCore.MediaLibraryAudio, error) {
	var entity domainCore.MediaLibraryAudio
	filter := bson.M{"_id": id}
...
func (r *mediaLibraryAudioRepository) Upsert(ctx context.Context, entity *domainCore.MediaLibraryAudio) error {
	entity.SetTimestamps()
...
func (r *mediaLibraryAudioRepository) CreateMany(ctx context.Context, entities []*domainCore.MediaLibraryAudio) error {
	var docs []interface{}
...
func (r *mediaLibraryAudioRepository) BulkUpsert(ctx context.Context, entities []*domainCore.MediaLibraryAudio) (int, error) {
...
func (r *mediaLibraryAudioRepository) GetAll(ctx context.Context) ([]*domainCore.MediaLibraryAudio, error) {
	...
	var entities []*domainCore.MediaLibraryAudio
	for cursor.Next(ctx) {
		var entity domainCore.MediaLibraryAudio
...
func (r *mediaLibraryAudioRepository) GetByFilter(ctx context.Context, filter interface{}) ([]*domainCore.MediaLibraryAudio, error) {
...
func (r *mediaLibraryAudioRepository) GetOneByFilter(ctx context.Context, filter interface{}) (*domainCore.MediaLibraryAudio, error) {
	var entity domainCore.MediaLibraryAudio
	err := r.db.Collection(r.collection).FindOne(ctx, filter).Decode(&entity)
	if err != nil {
		if err == driver.ErrNoDocuments {
...
func (r *mediaLibraryAudioRepository) GetPaginated(ctx context.Context, filter interface{}, skip, limit int64) ([]*domainCore.MediaLibraryAudio, error) {
	opts := options.Find().
		SetSkip(skip).
		SetLimit(limit).
...
// 上传下载相关方法
func (r *mediaLibraryAudioRepository) GetByLibraryID(ctx context.Context, libraryID primitive.ObjectID) ([]*domainCore.MediaLibraryAudio, error) {
	var entities []*domainCore.MediaLibraryAudio
...
func (r *mediaLibraryAudioRepository) GetByUploaderID(ctx context.Context, uploaderID primitive.ObjectID) ([]*domainCore.MediaLibraryAudio, error) {
	var entities []*domainCore.MediaLibraryAudio
...
func (r *mediaLibraryAudioRepository) GetByStatus(ctx context.Context, status string) ([]*domainCore.MediaLibraryAudio, error) {
	var entities []*domainCore.MediaLibraryAudio
...
func (r *mediaLibraryAudioRepository) GetByChecksum(ctx context.Context, checksum string) (*domainCore.MediaLibraryAudio, error) {
	var entity domainCore.MediaLibraryAudio
...
func (r *mediaLibraryAudioRepository) GetByFileName(ctx context.Context, fileName string) (*domainCore.MediaLibraryAudio, error) {
	var entity domainCore.MediaLibraryAudio
