...
type mediaLibraryAudioUsecase struct {
	mediaLibraryAudioRepo    scene_audio_db_interface.MediaLibraryAudioRepository
	chunkedUploadSessionRepo scene_audio_db_interface.ChunkedUploadSessionRepository
	basicFileUsecase         *usecase_file_entity.FileUsecase // 使用基础文件用例来触发扫描
	timeout                  time.Duration
}

func NewMediaLibraryAudioUsecase(
	repo scene_audio_db_interface.MediaLibraryAudioRepository,
	chunkedUploadSessionRepo scene_audio_db_interface.ChunkedUploadSessionRepository,
	basicFileUsecase *usecase_file_entity.FileUsecase,
	timeout time.Duration,
) scene_audio_route_interface.MediaLibraryAudioUsecase {
...
func (uc *mediaLibraryAudioUsecase) UploadAudioFile(ctx context.Context, fileData io.Reader, fileName, libraryIDStr, uploaderIDStr string) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	...
	if err == nil && existingFile != nil {
		...
		response := &scene_audio_route_models.MediaLibraryAudioResponse{
			ID:          existingFile.ID,
	...
	// 准备音频文件实体
	audioFile := &scene_audio_db_models.MediaLibraryAudio{
		FileName:   fileName,
		FileSize:   fileSize,
		Checksum:   checksum,
		LibraryID:  libraryID,
...
func (uc *mediaLibraryAudioUsecase) UploadAudioFileWithProgress(ctx context.Context, fileData io.Reader, fileName, libraryIDStr, uploaderIDStr string, progressCallback scene_audio_route_interface.ProgressCallback) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) DownloadAudioFileWithProgress(ctx context.Context, fileIDStr string, progressCallback scene_audio_route_interface.ProgressCallback) (io.Reader, string, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) GetAudioFileByID(ctx context.Context, fileIDStr string) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) GetAudioFilesByLibrary(ctx context.Context, libraryIDStr string) ([]*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
	...
	// 转换为响应模型
	var responses []*scene_audio_route_models.MediaLibraryAudioResponse
...
func (uc *mediaLibraryAudioUsecase) GetAudioFilesByUploader(ctx context.Context, uploaderIDStr string) ([]*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) ExtractFileInfo(ctx context.Context, fileIDStr string) (*scene_audio_route_models.FileInfo, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
	...
	// 创建基本的文件信息结构
	result := &scene_audio_route_models.FileInfo{
		ID:        fileID.Hex(),
		FileName:  audioFile.FileName,
...
func (uc *mediaLibraryAudioUsecase) extractDetailedAudioInfo(filePath string) (*scene_audio_route_models.FileInfo, error) {
...
func (uc *mediaLibraryAudioUsecase) extractDetailedAudioInfoWithTaglib(filePath string) (*scene_audio_route_models.FileInfo, error) {
...
func (uc *mediaLibraryAudioUsecase) UploadAudioFileChunked(ctx context.Context, fileData io.Reader, fileName, libraryIDStr, uploaderIDStr, uploadID string, chunkIndex, totalChunks int, isLastChunk bool) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
	...
	if !isLastChunk {
		...
		// 返回当前进度信息
		return &scene_audio_route_models.MediaLibraryAudioResponse{
			ID:       session.ID,
...
func (uc *mediaLibraryAudioUsecase) GetUploadProgress(ctx context.Context, uploadID string) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) GetDownloadProgress(ctx context.Context, fileID string) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) GetFileMetadata(ctx context.Context, fileIDStr string) (*scene_audio_route_models.MediaLibraryAudioResponse, error) {
	ctx, cancel := context.WithTimeout(ctx, uc.timeout)
	defer cancel()
...
func (uc *mediaLibraryAudioUsecase) getOrCreateChunkedUploadSession(ctx context.Context, uploadID, fileName string, libraryID, uploaderID primitive.ObjectID, totalChunks int) (*scene_audio_db_models.ChunkedUploadSession, error) {
	session, err := uc.chunkedUploadSessionRepo.GetByUploadID(ctx, uploadID)
	if err != nil {
		return nil, err
	}
	...
	if session == nil {
		// 创建新的上传会话
		session = &scene_audio_db_models.ChunkedUploadSession{
			UploadID:       uploadID,
			FileName:       fileName,
...
type ProgressReader struct {
	...
	totalSize        int64
	currentSize      int64
	progressCallback scene_audio_route_interface.ProgressCallback
}
