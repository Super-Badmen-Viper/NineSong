...
type RecommendationResult struct {
	...
	AnnotationBasis []annotationCore.AnnotationMetadata     `bson:"annotation_basis"` // 基于的注释信息
	TagBasis        []wordCloudCore.WordCloudMetadata      `bson:"tag_basis"`        // 基于的标签信息
	RelatedItems    []wordCloudCore.WordCloudRecommendation `bson:"related_items"`    // 相关项目信息
}
