...
type AlbumMetadata struct {
	...
	AllAlbumArtistIDs []artistCore.ArtistIDPair `bson:"all_album_artist_ids"` // 所有参与专辑艺术家的唯一标识符列表
...
// AlbumSongCounts 专辑歌曲计数
type AlbumSongCounts struct {
	ID        primitive.ObjectID `bson:"_id"`        // 文档唯一标识符
	SongCount int                `bson:"song_count"` // 专辑中的歌曲总数
}

// AlbumFilterParams 查询参数结构
