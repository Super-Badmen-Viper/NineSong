...
import (
	...
	syncRecordDomainCore "github.com/amitshekhariitbhu/go-backend-clean-architecture/domain/music/media_library/sync_record/core"
	"github.com/gin-gonic/gin"
	"go.mongodb.org/mongo-driver/bson/primitive"
)

type MediaLibraryAudioController struct {
	MediaLibraryAudioUsecase      domainCore.MediaLibraryAudioUsecase
	MediaLibrarySyncRecordUsecase domainCore.MediaLibrarySyncRecordUsecase
}

func NewMediaLibraryAudioController(uc domainCore.MediaLibraryAudioUsecase, syncRecordUsecase domainCore.MediaLibrarySyncRecordUsecase) *MediaLibraryAudioController {
...
func (c *MediaLibraryAudioController) UploadHandler(ctx *gin.Context) {
	...
	// 创建同步记录
	syncRecord := &syncRecordDomainCore.MediaLibrarySyncRecord{
	...
	if err != nil {
		// 更新同步记录状态为失败
		updatedSyncRecord := &syncRecordDomainCore.MediaLibrarySyncRecord{
